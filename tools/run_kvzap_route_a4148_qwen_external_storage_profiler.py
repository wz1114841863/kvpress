...
def make_backend_and_cache(*, path: str, pipe, layers: tuple[int, ...], expected_heads: dict[int, tuple[int, ...]], events, args: argparse.Namespace, component_measure=None, same_mask_numerical_guard_mode: str = "enforce"):
