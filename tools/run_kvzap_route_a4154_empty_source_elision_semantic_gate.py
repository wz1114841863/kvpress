...
def main() -> None:
    ...
    if total(elided_forced, "route_a_attention_pending") != 0: raise AssertionError("candidate still executed empty pending partial attention")
