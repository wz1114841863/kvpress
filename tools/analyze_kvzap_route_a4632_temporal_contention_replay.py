...
def replay(*, inventory: dict[Stream, dict[str, int]], arrivals: dict[Stream, list[int]], variant: dict[str, Any], policy: str) -> dict[str, Any]:
    ...
    grant_mapped_total = {field: value for field, value in total_mapped.items() if field != "modeled_post_service_dual_source_merge_state_records"}
